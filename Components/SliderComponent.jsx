                  ...
                  index === 1 && (
                    <div className=' text-white absolute inset-0 flex items-center justify-center '>
                      <div className='text-center space-y-2'>
                        ...
                        <h2 className='text-[#a91f64] sm:text-6xl lg:text-7xl font-bold flex justify-end'>
                          2025
                        </h2>
                      </div>
                    </div>
                  ...
                  index === 2 && (
                    <div className='absolute inset-0 flex items-center justify-center md:justify-end pr-10'>
                      <div className='w-1/2 flex flex-col items-center space-y-3'>
                        <span className=' text-[#a91f64] text-7xl md:text-9xl lg:text-7xl font-extrabold leading-none uppercase'>
                          Deal
                        </span>
                        <h2 className='text-black text-xl md:text-5xl font-semibold uppercase py-2
                        text-center bg-white w-fit px-3 sm:px-4'>
                          Of The Week
                        </h2>
