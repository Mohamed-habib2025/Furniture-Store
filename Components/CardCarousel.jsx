...
const PrevArrow = ({ onClick }) => (
  <button onClick={onClick} className='absolute left-[-8px] top-1/2 transform -translate-y-1/2 bg-white text-black shadow-md
...
const NextArrow = ({ onClick }) => (
  <button onClick={onClick} className='absolute right-[-8px] top-1/2 transform -translate-y-1/2 bg-white text-black shadow-md
  p-2 rounded-full hover:bg-[#a91f64] hover:text-white cursor-pointer transition-colors z-10 outline-none' >
